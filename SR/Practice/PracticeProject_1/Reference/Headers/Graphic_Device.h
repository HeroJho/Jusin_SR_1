...
public:
	HRESULT		InitDevice(HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, WINMODE eWinMode);
	void		SetParameters(D3DPRESENT_PARAMETERS& d3dpp, HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, WINMODE eWinMode);
