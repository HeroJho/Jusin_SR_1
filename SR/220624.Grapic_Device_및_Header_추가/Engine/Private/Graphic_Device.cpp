...
HRESULT CGraphic_Device::InitDevice(HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, WINMODE eWinMode)
{
...
void CGraphic_Device::SetParameters(D3DPRESENT_PARAMETERS & d3dpp, HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, WINMODE eWinMode)
{
